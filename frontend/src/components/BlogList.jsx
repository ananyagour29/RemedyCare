...
// //     const filteredBlogs = () => {
// //     return blogs
// //         .filter(blog => blog.isPublished)   // 👈 YE LINE ADD KARO
// //         .filter(blog => 
// //             input === '' 
// //             ? true 
...
//                     // map loops through each category and returns JSX for each one.
//                     <div key={item} className='relative'>
//                         {/* item is the category name, e.g. "Life Experiences". */}
// {/* Since each category name is unique, React can use it as the key. */}
//                         <button onClick={()=>setMenu(item)} className={`${menu===item&& 'text-white px-4 pt-0.5'}`}>
//                             {item}
//                             {menu==item &&( <motion.div  layoutId='underline' transition={{type:'spring',stiffness:500,damping:30}} className='absolute inset-0 bg-cyan-800 rounded-full -z-10'></motion.div>)}
//                         </button>
//                         </div>
//                    ))} 
//            </div>
