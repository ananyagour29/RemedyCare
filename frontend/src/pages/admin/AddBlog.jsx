...
//     }
//   },[])
//   // Server pe save karna isliye zaruri hai taaki blog permanent rahe
//   //  aur modify kiya ja sake; frontend user ka input bhejta hai aur backend database me store karta hai.
//     return(
...
//            </div>
//            <button disabled={isAdding} type='submit' className='mt-8 w-40 h-10 bg-cyan-600 text-white border-rounded cursor-pointer text-sm rounded'>{isAdding?'Adding...':'Add Blog'}</button>
//         </div>
//       </form>
//     )
// }
    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow-rounded">
        ...
        <button
          disabled={isAdding}
          type="submit"
          className="mt-8 w-40 h-10 bg-cyan-600 text-white cursor-pointer text-sm rounded"
        >
