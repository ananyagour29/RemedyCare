...
export const getBlogById=async(req,res)=>{
    try{
        ...
        if(!blog){
            return res.json({success:false,messagee:"Blog not found"});
        }
...
export const generateContent = async (req, res) => {
  try {
    ...
    const content = await main(prompt + ' Generate a very short blog content in simple text, only a few sentences.');
